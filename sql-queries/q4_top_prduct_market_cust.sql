-- Genrate report for top market, products, and customer by net sale.

-- we need to calculate net sale
-- Net Sale = Gross price - Pre invoice discount - post invoice discount
